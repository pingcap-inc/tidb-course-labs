...
ssh -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no -A ${HOST_PD1_PRIVATE_IP} ~/.tiup/bin/tiup install tidb-lightning:v7.5.1
...
nohup tiup tidb-lightning:v7.5.1 -config solution-lightning-p1.toml > nohup.out & 
sleep 10
