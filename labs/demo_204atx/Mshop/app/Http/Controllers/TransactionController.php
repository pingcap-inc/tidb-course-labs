...
class TransactionController extends Controller
{
    ...
    public function index()
    {
        ...
        // Use url() so pagination links respect APP_URL and URL_PREFIX (e.g. behind a proxy).
        $TransactionPaginate->withPath(url('/transactions'));
    ...
    public function listUserTransations($user_id)
    {
        ...
        // Use url() so pagination links respect APP_URL and URL_PREFIX (e.g. behind a proxy).
        $TransactionPaginate->withPath(url("/transactions/{$user_id}/user"));
