...
~/.tiup/bin/tiup cluster deploy tidb-test ${VERSION} ./solution-topology-eight-nodes.yaml --user ec2-user -i /home/ec2-user/.ssh/pe-class-key-${REGION_NAME}.pem --yes >> /home/ec2-user/create-cluster-vinput.log 2>&1
sleep 3;
